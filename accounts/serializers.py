...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    username = serializers.CharField(max_length=50, validators=[UniqueValidator(queryset=CustomUser.objects.all())])
